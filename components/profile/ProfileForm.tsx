...
const TRANSLATIONS: Record<string, any> = {
  fr: { title: 'Mon profil', subtitle: 'Gérer vos informations personnelles', nameTitle: 'Modifier le nom', fullName: 'Nom complet', save: 'Enregistrer', saving: 'Mise à jour…', pwTitle: 'Changer le mot de passe', newPw: 'Nouveau mot de passe', confirm: 'Confirmer', minChars: '6 caractères minimum', changePw: 'Changer le mot de passe', errorName: 'Erreur lors de la mise à jour.', successName: 'Nom mis à jour !', errorPw: 'Erreur lors de la mise à jour.', successPw: 'Mot de passe mis à jour !', mismatch: 'Les mots de passe ne correspondent pas.', tooShort: 'Minimum 6 caractères.' },
  en: { title: 'My Profile', subtitle: 'Manage your personal information', nameTitle: 'Edit name', fullName: 'Full name', save: 'Save', saving: 'Updating…', pwTitle: 'Change password', newPw: 'New password', confirm: 'Confirm', minChars: 'Minimum 6 characters', changePw: 'Change password', errorName: 'Error updating.', successName: 'Name updated!', errorPw: 'Error updating.', successPw: 'Password updated!', mismatch: 'Passwords do not match.', tooShort: 'Minimum 6 characters.' },
  de: { title: 'Mein Profil', subtitle: 'Persönliche Informationen verwalten', nameTitle: 'Name ändern', fullName: 'Vollständiger Name', save: 'Speichern', saving: 'Aktualisieren…', pwTitle: 'Passwort ändern', newPw: 'Neues Passwort', confirm: 'Bestätigen', minChars: 'Mindestens 6 Zeichen', changePw: 'Passwort ändern', errorName: 'Fehler.', successName: 'Name aktualisiert!', errorPw: 'Fehler.', successPw: 'Passwort aktualisiert!', mismatch: 'Passwörter stimmen nicht überein.', tooShort: 'Mindestens 6 Zeichen.' },
  lu: { title: 'Mäi Profil', subtitle: 'Perséinlech Informatiounen verwalten', nameTitle: 'Numm änneren', fullName: 'Vollstännegen Numm', save: 'Späicheren', saving: 'Aktualiséieren…', pwTitle: 'Passwuert änneren', newPw: 'Neit Passwuert', confirm: 'Bestätegen', minChars: 'Mindestens 6 Zeechen', changePw: 'Passwuert änneren', errorName: 'Feeler.', successName: 'Numm aktualiséiert!', errorPw: 'Feeler.', successPw: 'Passwuert aktualiséiert!', mismatch: 'Passwierder stëmmen net iwwereen.', tooShort: 'Mindestens 6 Zeechen.' },
}

export default function ProfileForm({ locale, currentName }: { locale: string; currentName: string }) {
